...
export default function HomePage() {
  ...
  useEffect(() => {
    fetch('/GlobeLife/lab-instructions/index.json')
      .then(r => r.json())
        ...
        <div className="max-w-6xl mx-auto px-8 py-12 flex items-center justify-between gap-8">
          <div className="flex-1 max-w-xl">
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              Welcome to the Hands-on Labs. This curated collection is designed to help mainframe developers get up and running with Bob through guided, practical exercises. Choose any lab to explore specific capabilities, build new skills, and experience how Bob can enhance your development workflow.
            </p>
            {labs.length > 0 && (
              <Link
                to={`/workshop/lab/${labs[0].id}`}
