    ...
    <aside className="w-52 shrink-0 bg-white border-r border-ibm-border flex flex-col h-full">
          ...
          return (
            ...
            >
              ...
              <span className="leading-snug">
                <span className="block text-xs font-medium leading-tight">{lab.title.replace(/^Lab \d+:\s*/, '')}</span>
              </span>
            </Link>
          )
        })}
      ...
      <div className="p-4 border-t border-ibm-border">
        <div className="flex items-center gap-2 mb-2">
          <img src="/GlobeLife/Bob2.png" alt="Bob" className="h-8 w-8 object-contain shrink-0" />
          <div>
